...
import ReservationCard, {
  ...
  type OptionSupp,
} from "../components/client/ReservationCard";

/**
 * Espace personnel du client.
 * Affiche l'historique complet des réservations liées au profil connecté.
 */
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-10">
          ...
          <p className="text-gray-500">
            Bienvenue {profil?.prenom}, voici l'historique de vos réservations.
          </p>
        </div>
        ...
        {reservations.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
            ...
            <p className="text-gray-500 mb-6">
              Vous n'avez pas encore réservé de véhicule avec nous.
            </p>
            <Link
              to="/"
